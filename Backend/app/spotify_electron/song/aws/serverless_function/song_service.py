...
import app.spotify_electron.user.artist.validations.artist_repository_validations as artist_repository_validations
...
async def create_song(  # noqa: C901
    ...
    try:
        ...
        artist_repository_validations.validate_user_should_be_artist(artist)
