...
def get_playlist(name: str) -> PlaylistDTO:
    ...
    return PlaylistDTO(name=playlist_data["name"], photo=playlist_data["photo"], song_names=playlist_data["song_names"],description=playlist_data["description"], fecha_adicion=playlist_data["upload_date"])
