...
from app.spotify_electron.song.song_service_constants import (
    ...
    SONG_SERVICE_STREAMING_AWS_SERVERLESS_MODULE_NAME,
)
...
class SongServiceProvider:
    ...
    def init_service(cls) -> None:
        ...
        cls.song_services = {
            AppArchitecture.ARCH_STREAMING_SERVERLESS: SONG_SERVICE_STREAMING_AWS_SERVERLESS_MODULE_NAME,  # noqa: E501
